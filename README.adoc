...
*** https://github.com/YanWenKun/ComfyUI-Windows-Portable/releases/download/latest/models.zip.001[models.zip.001] (If you are upgrading from a previous release, you don't need this file.)
