...
* 预装了 50+ 常用自定义节点 <<custom-nodes, 【查看详细列表】>>
...
|link:https://github.com/akatz-ai/ComfyUI-Depthflow-Nodes[Depthflow by akatz]
...
|link:https://github.com/akatz-ai/ComfyUI-X-Portrait-Nodes[X-Portrait by akatz]
|
|===
