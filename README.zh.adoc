...
** https://github.com/YanWenKun/ComfyUI-Windows-Portable/releases/download/latest/ComfyUI_Windows_portable_cu126.7z.001[ComfyUI_Windows_portable_cu126.7z.001]
** https://github.com/YanWenKun/ComfyUI-Windows-Portable/releases/download/latest/ComfyUI_Windows_portable_cu126.7z.002[ComfyUI_Windows_portable_cu126.7z.002]
** https://github.com/YanWenKun/ComfyUI-Windows-Portable/releases/download/latest/models.zip.001[models.zip.001] （模型包，如果是从之前版本升级，不需要下载）

** 打开 `.7z.001` 并解压（建议目录不要太深），打开 `.zip.001` 并解压到同一个目录。
...
. （按需）编辑启动脚本，`run_cn.bat` (中) 或 `run_nvidia_gpu.bat` (英)
